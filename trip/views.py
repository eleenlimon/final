...
class TripHomeView(TemplateView):
...
class NoteListView(ListView):
    ...
    def get_queryset(self):
        ...
        return queryset
    # overiding queryset w/ own variable to-> trip__owner gives access to model Trip object(owner)
...
class NoteCreateView(CreateView):
    ...
    def get_form(self):
        ...
        form.fields['trip'].queryset = trips  # modifying the to give a dropdown of only user's img
        return form
