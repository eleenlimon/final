...
from .views import TripHomeView, NoteCreateView, NoteDeleteView, NoteDetailView, NoteListView, NoteUpdateView, TripDeleteView, TripDetailView, TripUpdateView, trips_list, TripCreateView

urlpatterns = [
    path('', TripHomeView.as_view(), name="trip-home"),
